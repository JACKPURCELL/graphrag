...
if __name__ == "__main__":
    ...
    from graphrag.vector_stores.lancedb import LanceDBVectorStore
        ...
        # 步骤 1：找到排序最大的文件夹
    output_path = "./ragtest6/output" # "/Users/yh.wang/Academic/6/graphrag/ragtest6/output" # 
    ...
    description_embedding_store.connect(db_uri=LANCEDB_URI) # self.db_connection = lancedb.connect(db_uri)
    ...
    context_text, context_records = context_builder.build_context(
            query= "Help me to plan a trip to the Museum of Pop Culture in Seattle",
