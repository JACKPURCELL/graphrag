...
from build_corpus_1207_target import process_questions_v2,rewrite_txt_v2_only_writeone
...
clean_paths = [
    "/home/ljc/data/graphrag/alltest/ablation_new_1212/medi_v3_1207_tobeuse_only1_t2",
    "/home/ljc/data/graphrag/alltest/ablation_new_1212/location_1207_tobeuse_only1_t2",
    "/home/ljc/data/graphrag/alltest/ablation_new_1212/cyber_v3_tobeuse_only1_t3"]
for clean_path in clean_paths:
    new_base_path = clean_path+"_shuffle_target_t2"
    try:
        ...
        print(e)
        print(f"Copy clean output to {new_base_path} failed")
    try:
