...
from build_corpus_subgraph_exp1 import process_questions_v2,rewrite_txt_v2
from build_answer_v4_fornewq_subgraphv2_onlydir import process_corpus_file
import shutil
import os
...
new_path = base_path + '_exp1_noonly1_2'
