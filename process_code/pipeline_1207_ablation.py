...
clean_path = "/home/ljc/data/graphrag/alltest/ablation_new_1212/medi_v3_1207_tobeuse_only1_t2"

# directs = [1,3,5]
# for direct in directs:
#     new_base_path = "/home/ljc/data/graphrag/alltest/ablation_new_1212/medi_v3_1207_tobeuse_only1_t2_direct_"+str(direct)
#     try:
...
#     new_base_path = "/home/ljc/data/graphrag/alltest/ablation_new_1212/medi_v3_1207_tobeuse_only1_t2_enhance_"+str(enhance)
#     try:
#         shutil.copytree(clean_path, new_base_path)
#         print(f"Copy clean output to {new_base_path}")
#         shutil.rmtree(os.path.join(new_base_path, 'output'))
...
for repliaction in repliactions:
    ...
    new_base_path = "/home/ljc/data/graphrag/alltest/ablation_new_1212/medi_v3_1207_tobeuse_only1_t2_repli_"+str(repliaction)
    try:
        shutil.copytree(clean_path, new_base_path)
        print(f"Copy clean output to {new_base_path}")
        shutil.rmtree(os.path.join(new_base_path, 'output'))
        ...
        pass 
    rewrite_txt_v2_only_writeone(new_base_path,repeat_count=repliaction,num_keep_direct=10,num_keep_indirect=5)
    # run_command(new_base_path)
    # corpus_file = new_base_path + '/test0_corpus.json'
    # process_corpus_file(new_base_path, corpus_file)   
...
# directs = [1,3,5]
# for direct in directs:
#     new_base_path = "/home/ljc/data/graphrag/alltest/ablation_new_1212/location_1207_tobeuse_only1_t2_direct_"+str(direct)
#     try:
#         shutil.copytree(clean_path, new_base_path)
#         print(f"Copy clean output to {new_base_path}")
#         shutil.rmtree(os.path.join(new_base_path, 'output'))
