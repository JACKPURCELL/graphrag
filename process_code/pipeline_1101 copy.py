...
from build_corpus_1023 import process_questions_v2,rewrite_txt_v2
from build_answer_v4_1023 import process_corpus_file
import shutil
import os


base_path = "/home/ljc/data/graphrag/alltest/location_med_exp/medical_dataset_base1101"

# 调用函数并传递 base_path 参数
print("=======Start generate_questions")
generate_questions(base_path,question_count=10,multi_root_node=True)

new_path = base_path + '_exp1101_multi_root_node'

    
    
print("=======Start build corpus")
process_questions_v2(base_path,new_path,attack_middlewithleaf=True)
