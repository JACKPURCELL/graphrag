...
clean_paths = [
    "/home/ljc/data/graphrag/alltest/para_1212/cyber_v3_tobeuse_only1_t3_shuffle",
    "/home/ljc/data/graphrag/alltest/para_1212/location_1207_tobeuse_only1_t2_shuffle",
    "/home/ljc/data/graphrag/alltest/para_1212/medi_v3_1207_tobeuse_only1_t2_shuffle_direct_3"]
...
for clean_path in clean_paths:
    ...
    try:
        ...
        corpus_file = clean_path + '/test0_corpus.json'
        process_corpus_file(clean_path, corpus_file)   
    except:
        pass
