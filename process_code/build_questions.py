...
base_prompt = """
    ...
    Using the graph provided, which consists of nodes and edges representing relationships derived from the text, generate some Multi-Source Reasoning questions. Each question should consider two, or three edges to ensure depth and complexity. 
    ...
    {
    "question": "Are MUSÉE MATISSE and MUSÉE RODIN in the same place?",
    "answer": "No",
    ...
    {
    "question": "Are CHARLES DE GAULLE in the capital  of France?",
    "answer": "Yes",
    ...
    {
    "question": "Which country is the OREGON TREATY in?",
    "answer": "UNITED STATES OF AMERICA",
    "explanation":None,
    "entities": [[OREGON TREATY, UNITED STATES OF AMERICA]]
    }
    {
    ...
    Create 5 questions that utilize the relationships between nodes effectively.
    Ensure that the answers are derived logically from the graph.
    Present the questions and answers in JSON format as shown in the examples.
