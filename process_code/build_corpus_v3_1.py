...
def process_questions_v3_1(base_path):
    ...
    adv_prompt_path = Path(os.path.join(base_path, 'question_v3_1_corpus.json'))
    ...
    output_path_indirect = Path(base_path) / 'adv_texts_indirect_v3_1.txt'
    output_path_indirect.write_text('\n\n'.join(indirect_adv_texts), encoding='utf-8')
    
    output_path_direct = Path(base_path) / 'adv_texts_direct_v3_1.txt'
...
if __name__ == "__main__":
    ...
    process_questions_v3_1(base_path)