...
def extract_info(content):
    ...
    for software in software_names:
        ...
        filled_template = {key: value.format(
            ...
            KnowledgeGraph=knowledge_graph_entries  # Convert list of lists to JSON
        ) if isinstance(value, str) else value for key, value in template.items()}
        ...
        return_jsons.append(filled_template)
      
    output_json = {}
    output_json["questions"] = return_jsons
    output_json["middle_node"] = return_jsons[0]["middle_node"]
    output_json["as_source"] = [[return_jsons[0]["middle_node"], leaf_node] for leaf_node in return_jsons[0]["leaf_nodes"]]
    output_json["as_target"] = []
...
directory = '/home/ljc/data/graphrag/alltest/new_corpus_1207/revised'
save_jsons = []
...
for filename in os.listdir(directory):
    ...
    if filename.endswith('.txt'):
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            content = file.read()
            save_jsons.append(extract_info(content))
            
            
with open('/home/ljc/data/graphrag/alltest/new_corpus_1207/question_multi_v3.json', 'w') as f:
